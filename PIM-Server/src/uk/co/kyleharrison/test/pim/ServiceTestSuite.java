...
import uk.co.kyleharrison.test.pim.service.ISBNDBServiceTest;
...
@SuiteClasses({ AsylumServiceTest.class, ComicVineIssueTest.class,
		ComicVineServiceTest.class,SpotifyServiceTest.class, OmdbServiceTest.class,ISBNDBServiceTest.class })
