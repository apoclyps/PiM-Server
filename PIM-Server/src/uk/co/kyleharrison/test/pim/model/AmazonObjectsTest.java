...
public class AmazonObjectsTest {
	...
	public void createAmazonItem(){
		//Parameters - String asin, String title, int price, String URL, String imageURL, String reviewURL
		AmazonItem amazonItem = new AmazonItem("123456789","Default Item", 399,"www.item.com","www.item.com/image","www.item.com/review");
...
//		AmazonItem amazonItem = new AmazonItem("123456789","Default Item", 399,"www.item.com","www.item.com/image","www.item.com/review");
//		System.out.println(amazonItem.toString());
//		
...
//"}";
//		
//		assertEquals(amazonItem.getReviewURL().toString(),result);
//	}
